                            ...
                            <div class="label_g2">
                                <label class="label">
                                    ...
                                    <select name="experience" class="select2">
                                        <option
                                            value="Cobertura" {{ (old('experience') == 'Cobertura' ? 'selected' : ($property->experience == 'Cobertura' ? 'selected' : '')) }}>
                                            Cobertura
                                        </option>
                                        <option
                                            value="Alto Padrão" {{ (old('experience') == 'Alto Padrão' ? 'selected' : ($property->experience == 'Alto Padrão' ? 'selected' : '')) }}>
                                            Alto Padrão
                                        </option>
                                        <option
                                            value="De Frente para o Mar" {{ (old('experience') == 'De Frente para o Mar' ? 'selected' : ($property->experience == 'De Frente para o Mar' ? 'selected' : '')) }}>
                                            De Frente para o Mar
                                        </option>
                                        <option
                                            value="Condomínio Fechado" {{ (old('experience') == 'Condomínio Fechado' ? 'selected' : ($property->experience == 'Condomínio Fechado' ? 'selected' : '')) }}>
                                            Condomínio Fechado
                                        </option>
                                        <option
                                            value="Compacto" {{ (old('experience') == 'Compacto' ? 'selected' : ($property->experience == 'Compacto' ? 'selected' : '')) }}>
                                            Compacto
                                        </option>
                                        <option
                                            value="Lojas e Salas" {{ (old('experience') == 'Lojas e Salas' ? 'selected' : ($property->experience == 'Lojas e Salas' ? 'selected' : '')) }}>
                                            Lojas e Salas
                                        </option>
                                    </select>
                                </label>
                                    ...
                                    <div class="property_image_item">
                                        ...
                                        <div class="property_image_actions">
                                            <a href="javascript:void(0)"
                                               class="btn btn-small icon-check icon-notext image-set-cover {{ ($image->cover == true ? 'btn-green' : '') }}"
                                               data-action="{{ route('admin.properties.imagesSetCover', ['image' => $image->id]) }}"></a>
                                            <a href="javascript:void(0)"
                                               class="btn btn-red btn-small icon-times icon-notext image-remove"
                                               data-action="{{ route('admin.properties.imagesRemove', ['image' => $image->id]) }}"></a>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
